										...
										<div class="card card-custom gutter-b card-stretch">
											...
											<div class="card-body">
												<div class="row">
													<div class="col-md-3">
														<!--begin::Chart-->
														<div id="kt_mixed_widget_cpu_chart" style="height: 250px"></div>
														<!--end::Chart-->
													</div>

													<div class="col-md-3">
														<!--begin::Chart-->
														<div id="kt_mixed_widget_ram_chart" style="height: 250px"></div>
														<!--end::Chart-->
													</div>

													<div class="col-md-3">
														<!--begin::Chart-->
														<div id="kt_mixed_widget_battery_chart" style="height: 250px"></div>
														<!--end::Chart-->
													</div>

													<div class="col-md-3">
														<!--begin::Chart-->
														<div id="kt_mixed_widget_ssd_chart" style="height: 250px"></div>
														<!--end::Chart-->
													</div>
												</div>
											</div>
